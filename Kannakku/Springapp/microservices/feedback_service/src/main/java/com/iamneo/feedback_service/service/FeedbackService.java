...
public class FeedbackService {
	...
	public boolean addFeedback(FeedbackRequest feedbackRequest) {
		var feedback = Feedback.builder().email(feedbackRequest.getEmail()).rating(feedbackRequest.getRating()).service(feedbackRequest.getService()).feedback(feedbackRequest.getFeedback()).build();
